%% script_test_fcn_arcFit_curvatureAtPoint
% Exercises the function: fcn_arcFit_curvatureAtPoint
...
index_to_test = 200;
[point_curvature, point_circle_center, index_range, point_curvature_minimum] = fcn_arcFit_curvatureAtPoint(points_to_fit, index_to_test, [], (fig_num));
